...
#define UNSTABLE_ATV_MAX_CNT        58
        ...
        switch (sm_p->state)
        {
                case TVIN_SM_STATUS_NOSIG:
                        ...
                        else if (sm_ops->nosig(devp->frontend))
                        {
                                ...
                                if (sm_p->state_counter >= NOSIG_MAX_CNT)
                                {
                                        sm_p->state_counter       = NOSIG_MAX_CNT;
                        ...
                        else
                        {
                                ...
                                if (sm_p->exit_nosig_counter >= EXIT_NOSIG_MAX_CNT)
                                {
                        ...
                        else
                        {
...

                                {
                                        ...
                                        if((port == TVIN_PORT_CVBS0)&&devp->unstable_flag)
                                                ...
                                                unstable_in_cnt = UNSTABLE_MAX_CNT;
                                ...
                                else
                                {
                                        ...
                                        if(port == TVIN_PORT_CVBS0)
                                                ...
                                                unstable_in_cnt = BACK_STABLE_MAX_CNT;
                ...
                case TVIN_SM_STATUS_PRESTABLE:
                        {
                                ...
                                {
                                        ++sm_p->state_counter;
                                        if (sm_p->state_counter >= EXIT_STABLE_MAX_CNT)
                                        {
                                                tvin_smr_init_counter(devp->index);
                                                sm_p->state = TVIN_SM_STATUS_UNSTABLE;
                                                if (sm_debug_enable)
                                                ...
                                                (port <= TVIN_PORT_COMP7))
                                {
                                        ...
                                        if (sm_p->exit_prestable_counter >= EXIT_PRESTABLE_MAX_CNT)
                                        {
                                                tvin_smr_init_counter(devp->index);
                ...
                case TVIN_SM_STATUS_STABLE:
                        {
                                ...
                                if (nosig || fmt_changed /* || !pll_lock */)
                                {
                                        ...
                                        if (port == TVIN_PORT_CVBS0)
                                                ...
                                                stable_out_cnt = EXIT_STABLE_MAX_CNT;
